...
function App() {
  ...
  return <>
    ...
    <footer className="footer"><div className="wrap footer-inner"><a className="brand" href="#top"><span className="brand-mark">P<span>.</span></span><span className="brand-name">PRASHANT SINGH</span></a><span className="footer-note">Built with intention. Auckland, New Zealand.</span><a className="footer-social" href="https://github.com/prshnt24" target="_blank" rel="noreferrer"><Github size={14} /> GitHub</a><a href="#top" className="back-top">BACK TO TOP <ArrowUpRight size={13} /></a><span className="footer-copy">© {new Date().getFullYear()} PRASHANT SINGH</span></div></footer>
  </>;
}
